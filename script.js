...
const priceMap = {
    Мідь: { price: 367, waste: 1 },
    Латунь: { price: 236, waste: 1 },
    'Радіатор латунний': { price: 235, waste: 2 },
    ...
    'Акумулятор чорний': { price: 17, waste: 1 },
    'ТНЖ великі': { price: 20, waste: 3 },
    'ТНЖ маленькі': { price: 18, waste: 3 },
    Титан: { price: 82, waste: 0.5 },
    'Високолегована сталь 18-99% Ni': { price: 4100, waste: 0 },
